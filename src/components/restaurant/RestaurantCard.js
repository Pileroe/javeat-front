    ...
    return (
        <div className='col-md-4 mb-4'>
            <div className="card h-100">
                <img src={props.restaurant.img_url} className="card-img-top" alt="Restaurant Image" />
                <div className="card-body">
                    ...
                    <p className="card-text"><strong>Food Types:</strong> {props.restaurant.food_types.join(', ')}</p>
